					...
					<div class="x_panel">
					  ...
					  <div class="x_content">
						...
						<table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
						  ...
						  <tbody>
							<?php 
							$admin_data=sqlfetch("SELECT * FROM admin order by id desc");
							if(count($admin_data))
							...
							<tr>
							  <td><input type="checkbox" value="<?=$admin['id'];?>" class="flat" name="table_records[]"></td>
							  <td><?=$admin['fname'].' '.$admin['lname'];?></td>
							  <td><?=$admin['email'];?></td>
							  <td><?=$admin['password'];?></td>
							  <td><?=$admin['phone'];?></td>
							  <td><?=get_active_status_text($admin['actstat']);?></td>
							  <td>
								<a href="add_admin.php?pid=<?=$admin['id'];?>&edit=true"><i class="fa fa-pencil pull-left"></i></a>
							  </td>
							</tr>
							<?php 
								}
