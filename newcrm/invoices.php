					...
					<div class="x_panel">
					  ...
					  <div class="x_content">
						...
						<table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
						  ...
						  <tbody>
							<?php 
							$invoices_data=sqlfetch("SELECT * FROM invoices order by id desc");
							if(count($invoices_data))
								foreach($invoices_data as $invoices)
								{ ?>
							<tr>
							  <td><input type="checkbox" value="<?=$invoices['id'];?>" class="flat" name="table_records[]"></td>
							  <td><?=get_customer_name($invoices['cid']);?></td>
							  <td><?=get_admin_name_by_id($invoices['sales_id']);?></td>
							  <td><?=date('d M Y H:i', strtotime($invoices['dated']));?></td>
							  <td><?=$invoices['price'];?></td>
							  <td><?=get_active_status_text($invoices['actstat']);?></td>
							  <td><?=get_package_name($invoices['package']);?></td>
							  <td>
								<a href="add_invoices.php?pid=<?=$invoices['id'];?>&edit=true"><i class="fa fa-pencil pull-left"></i></a>
								<a title="Invoices" href="invoices.php?sid=<?=$invoices['id'];?>"><i class="fa fa-file-pdf-o pull-right"></i></a>
							  </td>
							</tr>
							<?php
								}
