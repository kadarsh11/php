...
if(isset($_POST['deleteall']))
{
	...
	$q=del_str('cgroup',' id in ('.$str_rest_refs.') ');
					...
					<div class="x_panel">
					  ...
					  <div class="x_content">
						...
						<table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
						  ...
						  <tbody>
							<?php 
							$cgroup_data=sqlfetch("SELECT * FROM cgroup order by id desc");
							...
							<tr>
							  <td><input type="checkbox" value="<?=$cgroup['id'];?>" class="flat" name="table_records[]"></td>
							  <td><?=$cgroup['name'];?></td>
							  <td><?=get_active_status_text($cgroup['actstat']);?></td>
							  <td><?=$cgroup['fld_order'];?></td>
							  <td>
								<a href="add_cgroup.php?pid=<?=$cgroup['id'];?>&edit=true"><i class="fa fa-pencil pull-left"></i></a>
							  </td>
							</tr>
							<?php 
								}
