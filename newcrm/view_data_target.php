					...
					<div class="x_panel">
					  ...
					  <div class="x_content">
						...
						<table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
						  ...
						  <tbody>
							<?php 
							$data_target_data=sqlfetch("SELECT * FROM data_target order by id desc");
							if(count($data_target_data))
								foreach($data_target_data as $data_target)
								{ ?>
									

							<tr>
							  <td><input type="checkbox" value="<?=$data_target['id'];?>" class="flat" name="table_records[]"></td>
							  <td><?=get_admin_name_by_id($data_target['data_operator_id']);?></td>
							  <td><?=$data_target['target'];?></td>
							  <td>
								<a href="add_data_target.php?pid=<?=$data_target['id'];?>&edit=true"><i class="fa fa-pencil pull-left"></i></a>
							  </td>
							</tr>
							<?php 
								}
