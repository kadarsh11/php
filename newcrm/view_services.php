					...
					<div class="x_panel">
					  ...
					  <div class="x_content">
						...
						<table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
						  ...
						  <tbody>
							<?php 
							$services_data=sqlfetch("SELECT * FROM services order by id desc");
							if(count($services_data))
								foreach($services_data as $services)
								{ ?>
									

							<tr>
							  <td><input type="checkbox" value="<?=$services['id'];?>" class="flat" name="table_records[]"></td>
							  <td><?=$services['name'];?></td>
							  <td><?=$services['price'];?></td>
							  <td><?=get_active_status_text($services['actstat']);?></td>
							  <td><?=$services['fld_order'];?></td>
							  <td>
								<a href="add_services.php?pid=<?=$services['id'];?>&edit=true"><i class="fa fa-pencil pull-left"></i></a>
							  </td>
							</tr>
							<?php 
								}
