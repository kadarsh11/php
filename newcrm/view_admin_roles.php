					...
					<div class="x_panel">
					  ...
					  <div class="x_content">
						...
						<table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
						  ...
						  <tbody>
							<?php 
							$admin_roles_data=sqlfetch("SELECT * FROM admin_roles order by fld_order desc");
							if(count($admin_roles_data))
								foreach($admin_roles_data as $admin_roles)
								{ ?>
									

							<tr>
							  <td><input type="checkbox" value="<?=$admin_roles['id'];?>" class="flat" name="table_records[]"></td>
							  <td><?=$admin_roles['name'];?></td>
							  <td><?=get_active_status_text($admin_roles['actstat']);?></td>
							  <td><?=$admin_roles['fld_order'];?></td>
							  <td>
								<a href="add_admin_roles.php?pid=<?=$admin_roles['id'];?>&edit=true"><i class="fa fa-pencil pull-left"></i></a>
							  </td>
							</tr>
							<?php 
								}
