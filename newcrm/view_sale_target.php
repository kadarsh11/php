					...
					<div class="x_panel">
					  ...
					  <div class="x_content">
						...
						<table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
						  ...
						  <tbody>
							<?php 
							$sale_target_data=sqlfetch("SELECT * FROM sale_target order by id desc");
							if(count($sale_target_data))
								foreach($sale_target_data as $sale_target)
								{ ?>
									

							<tr>
							  <td><input type="checkbox" value="<?=$sale_target['id'];?>" class="flat" name="table_records[]"></td>
							  <td><?=get_admin_name_by_id($sale_target['sales_id']);?></td>
							  <td><?=$sale_target['target'];?></td>
							  <td>
								<a href="add_sale_target.php?pid=<?=$sale_target['id'];?>&edit=true"><i class="fa fa-pencil pull-left"></i></a>
							  </td>
							</tr>
							<?php 
								}
