					  ...
					  <div class="x_content">
						...
						<table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
						  ...
						  <tbody>
							<?php 
							$cust_id_arr=array();
							$all_erp_clients=sqlfetch("SELECT DISTINCT cid as cust_id FROM sales_data_assign ");
							...
							$customer_query="SELECT * FROM customer where verify_stat='1' and !(id in ($cust_id_str)) order by id desc";
