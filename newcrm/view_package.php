					...
					<div class="x_panel">
					  ...
					  <div class="x_content">
						...
						<table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
						  ...
						  <tbody>
							<?php 
							$package_data=sqlfetch("SELECT * FROM package order by id desc");
							...
							<tr>
							  <td><input type="checkbox" value="<?=$package['id'];?>" class="flat" name="table_records[]"></td>
							  <td><?=$package['name'];?></td>
							  <td><?=$package['max_no_of_product'];?></td>
							  <td><?=$package['max_no_of_enquiry'];?></td>
							  <td><?=$package['price'];?></td>
							  <td><?=get_active_status_text($package['actstat']);?></td>
							  <td><?=$package['fld_order'];?></td>
							  <td>
								<a href="add_package.php?pid=<?=$package['id'];?>&edit=true"><i class="fa fa-pencil pull-left"></i></a>
							  </td>
							</tr>
							<?php 
								}
